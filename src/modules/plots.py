...
def genera_plots_inflacionados():
    ...
    get_balanza_comercial(serie_historica_bc, serie_cpi_usa, acumulado=False).to_excel("output/serie_historica_mensual.xlsx")
    get_balanza_comercial(serie_historica_bc, serie_cpi_usa, acumulado=False).to_excel("output/serie_historica_acumulada.xlsx")
